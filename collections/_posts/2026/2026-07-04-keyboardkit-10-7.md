---
title:  KeyboardKit 10.7 is out
date:   2026-07-04 06:00:00 +0100
tags:   releases proxy settings styling

image-show: 0
image: /assets/versions/10_7.jpg
assets: /assets/blog/26/0626/

undo: /blog/2026/06/24/undo-support-is-coming-to-keyboardkit
v10_6: /blog/2026/06/22/keyboardkit-10-6

release: https://github.com/KeyboardKit/KeyboardKit/releases/tag/10.7.0
---

KeyboardKit 10.7 is out! This version adds undo capabilities to the keyboard, adds many new settings pickers, and finishes the namespace refactoring that was initially planned for KeyboardKit 11.

![KeyboardKit header image]({{page.image}})

This release comes out close to [KeyboardKit 10.6]({{page.v10_6}}), which was released not even two weeks ago. The reason is to get these new things out and get your feedback before KeyboardKit 11.
